    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-neutral-900 mb-4">About Us</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-8 mt-8">
              <div className="text-center">
                <h4 className="text-4xl font-bold text-neutral-900">500+</h4>
                <p className="text-neutral-600">Participants Served</p>
              </div>
              <div className="text-center">
                <h4 className="text-4xl font-bold text-neutral-900">20+</h4>
                <p className="text-neutral-600">Expert Team Members</p>
              </div>
            </div>
          </div>
        </div>
